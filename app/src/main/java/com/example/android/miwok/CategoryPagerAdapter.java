...
public class CategoryPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                args.putInt("itemBgColorResId", R.color.category_numbers);
            ...
            case 1:
                args.putInt("itemBgColorResId", R.color.category_family);
            ...
            case 2:
                args.putInt("itemBgColorResId", R.color.category_colors);
            ...
            case 3:
                args.putInt("itemBgColorResId", R.color.category_phrases);
